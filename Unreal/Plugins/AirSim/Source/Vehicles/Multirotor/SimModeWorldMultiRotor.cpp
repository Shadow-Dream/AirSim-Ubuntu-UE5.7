    ...
    const PawnSimApi::Params& pawn_sim_api_params) const
{
    ...
    auto vehicle_sim_api = std::unique_ptr<PawnSimApi>(new MultirotorPawnSimApi(pawn_sim_api_params, vehicle_pawn->getKeyBoardControls()));
