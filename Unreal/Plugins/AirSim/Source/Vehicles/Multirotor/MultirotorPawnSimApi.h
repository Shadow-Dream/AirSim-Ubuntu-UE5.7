...
public:
    ...
    MultirotorPawnSimApi(const Params& params, const msr::airlib::RCData& keyboard_controls);
...
private:
    void logAppliedControl(const msr::airlib::RCData& rc_data, bool using_keyboard);
    ...
    const msr::airlib::RCData& keyboard_controls_;
    double last_control_log_time_;
    double last_state_log_time_;
    msr::airlib::RCData last_logged_control_;
    bool last_logged_using_keyboard_;
};
