...
namespace airlib
{
    ...
    public:
        ...
        virtual string addLabel(const Pose& pose, const Vector3r& size, const vector<float>& color_rgba) = 0;
        virtual bool destroyLabel(const std::string& label_id) = 0;
        virtual uint32_t destroyAllLabels() = 0;
        virtual void notifyImageCapturesSceneChanged() = 0;
