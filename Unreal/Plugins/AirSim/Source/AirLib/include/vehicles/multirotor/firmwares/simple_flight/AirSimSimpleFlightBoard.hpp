...
namespace airlib
{
    ...
    public:
        ...
        void setIsLocalInputDisabled(bool is_disabled)
        {
            is_local_input_disabled_ = is_disabled;
        }
    ...
    public:
        ...
        virtual bool isLocalInputDisabled() const override
        {
            return is_local_input_disabled_;
        }
        ...
        virtual void reset() override
        {
            ...
            is_connected_ = false;
            is_local_input_disabled_ = false;
        }
