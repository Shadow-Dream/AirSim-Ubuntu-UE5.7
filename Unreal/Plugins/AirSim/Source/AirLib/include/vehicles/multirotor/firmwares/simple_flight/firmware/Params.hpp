...
public:
    ...
    struct VelocityPid
    {
        ...
        // Bias Z velocity output so zero-error hover maps closer to the empirical hover throttle (~0.58)
        // for the CitySample quad instead of the default 0.50 neutral throttle.
        Axis4r output_bias = Axis4r(0, 0, 0, -0.26f);
    ...
    uint64_t api_goal_timeout = 60000; // milliseconds; allow long single-goal climbs / position moves in heavy UE sessions before safety hover triggers
