...
private: //methods
    ...
    typedef AirSimSettings::CineCameraSetting CineCameraSetting;

    static unsigned int imageTypeCount();
    void enableCaptureComponent(const ImageType type, bool is_enabled);
    static void updateCaptureComponentSetting(const ImageType image_type, USceneCaptureComponent2D* capture, UTextureRenderTarget2D* render_target,
    ...
    static void applyCineCameraSetting(UCineCameraComponent* camera, const CineCameraSetting& setting);
    void copyCameraSettingsToAllSceneCapture(UCameraComponent* camera);
    void copyCameraSettingsToSceneCapture(UCameraComponent* src, USceneCaptureComponent2D* dst, ImageType capture_type);
    //end CinemAirSim
};
